classdef Control < robotics.ros.Message
    %Control MATLAB implementation of car_msgs/Control
    ...
    properties (Constant)
        MessageType = 'car_msgs/Control' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.car_msgs.Control.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.car_msgs.Control;
            obj.reload(strObj);
        end
    end
end
